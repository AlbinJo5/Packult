...
export const data = [
  {
    ...
    image: "/assets/images/brand-owners/box (3).png",
    link: ROUTES.VALUE_IMPROVEMENT,
  },
  {
    number: "2.",
    heading: "Packaging Innovations",
    content:
      "Our team of dedicated and experienced packaging experts from multiple packaging domains bring creativity and knowledge under one roof and we provide world class future-ready packaging solutions that elevates product quality, improves imagery, and enhances shelf appeal within the cost brief. From concept to implementation our experts have it all covered. We pride ourselves on providing top-notch packaging solutions to businesses of all sizes. From development of packaging concepts, innovative shapes, 2D / 3D modelling, mock-ups, artworks, structure and specifications, we take care of all your packaging innovation needs",
    image: "/assets/images/brand-owners/box (1).png",
    // "links": [
    //     {
    //         "text": "Graphic Design",
    //         "link": "/"
